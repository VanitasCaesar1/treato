...
const PricingCard = ({ plan, isSelected, onClick }) => {
  ...
  return (
    <motion.div
      className={`w-full rounded-xl p-6 cursor-pointer transition-all duration-300 ${
        isSelected
    ...
    >
      <div className="flex items-start justify-between">
        <div>
          <h3
            className={`text-xl font-semibold mb-2 ${isSelected ? "text-[#37AFE1]" : "text-gray-800"}`}
          >
            {name}
          </h3>
...
const PricingDetails = ({ selectedPlan }) => {
  ...
  return (
    <motion.div
      className="bg-white rounded-xl p-8 shadow-lg border-2 border-[#37AFE1]/20"
      layout
    ...
    >
      ...
      <div className="space-y-4">
        {selectedPlan.features.map((feature, index) => (
          ...
          >
            <div className="w-6 h-6 rounded-full bg-[#37AFE1]/10 flex items-center justify-center mr-3">
              <Check className="w-4 h-4 text-[#37AFE1]" />
            </div>
      ...
      <Button className="w-full mt-8 bg-[#37AFE1] hover:bg-[#2490C4] text-white transition-colors">
        Get Started
...
const AnimatedPricing = () => {
  ...
  return (
    <section className="py-32 h-screen bg-gradient-to-b from-[#37AFE1]/10 via-white to-white">
      <div className="max-w-7xl mx-auto px-8">
        <div className="text-center mb-16">
          ...
          >
            <span className="text-[#37AFE1] font-semibold">Pricing Plans</span>
          </motion.div>
          <motion.h2
